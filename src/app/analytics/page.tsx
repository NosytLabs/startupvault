...
export default function AnalyticsPage() {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-b from-white via-orange-50/20 to-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="mb-12 animate-fade-in-up">
            <div className="inline-block mb-4 px-4 py-2 bg-accent/10 text-accent rounded-full text-sm font-semibold border border-accent/20">
              📈 Market insights
            </div>
