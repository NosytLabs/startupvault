...
export default function FeaturesPage() {
  const features = [
    {
      icon: '📊',
      title: '105 Verified Startups',
      description: 'Browse real companies with authenticated revenue and MRR data from TrustMRR.com. All 105 startups generating $150B+ combined revenue.'
    },
    {
      icon: '🔍',
        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          <div className="bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 border border-primary/20 rounded-lg p-12 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Start with the free Explorer plan to browse all 105 verified startups. Upgrade to Builder for advanced features like website scanning and document generation.
            </p>
