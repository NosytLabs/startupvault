          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8">
              <span style={{
                ...
                ✓ AUTHENTIC Data • 48 Verified Startups • $1.05B+ Revenue
              </span>
            </div>
            <h1 style={{
            ...
            <p style={{
              ...
              Browse 48 verified startups, scan their websites for insights, and generate actionable build documentation for your own ventures.
            </p>
