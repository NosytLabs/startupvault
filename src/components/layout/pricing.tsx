    ...
    <section className="py-20 bg-secondary/20">
      <div className="container px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Simple pricing for startup research and cloning</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="p-8 rounded-lg border bg-card hover:shadow-lg transition">
            ...
            <p className="text-sm text-muted-foreground mb-4">For research</p>
            ...
            <ul className="space-y-3 mb-8 text-sm">
              ...
              <li className="flex items-center gap-2"><span className="text-primary">✓</span> Industry filtering</li>
          ...
          <div className="p-8 rounded-lg border-2 border-primary bg-primary/10 scale-105 shadow-lg">
            ...
            <p className="text-sm text-muted-foreground mb-4">For cloning</p>
            ...
            <ul className="space-y-3 mb-8 text-sm">
              ...
              <li className="flex items-center gap-2"><span className="text-primary">✓</span> Website scanning</li>
              <li className="flex items-center gap-2"><span className="text-primary">✓</span> Build documentation</li>
              <li className="flex items-center gap-2"><span className="text-primary">✓</span> PRD & MVP guides</li>
            </ul>
          ...
          <div className="p-8 rounded-lg border bg-card hover:shadow-lg transition">
            ...
            <ul className="space-y-3 mb-8 text-sm">
              ...
              <li className="flex items-center gap-2"><span className="text-primary">✓</span> Custom analysis</li>
            </ul>
